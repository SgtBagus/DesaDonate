  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Produk/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-body">
                <div class="show_error"></div><div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form-gambar" placeholder="Masukan Gambar" name="dt[gambar]">
                  </div><div class="form-group">
